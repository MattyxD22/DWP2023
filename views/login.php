...
<article class="flex justify-center items-center flex-col login_container">
    ...
    <form class="login_form_class" method="post" action="<?php echo BASE_URL; ?>/controllers/UserController.php?action=login">
        ...
        <div class="py-3 flex flex-col">
            ...
            <input class="input_user std_input w-[500px]" type="text" name="username">
        </div>
        <div class="py-3 flex flex-col">
            <label class="text-red-600 text-xl" for="password">Password:</label><br>
            <input class="input_password std_input w-[500px]" type="password" name="password">
        </div>

        <div class="py-3 flex flex-row justify-around">
            <button type="submit" class="std_button text-white font-bold py-2 px-4 rounded login_btn">
