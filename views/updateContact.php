...
<article class="w-full">
    <form class="flex flex-col gap-4 text-black justify-center w-full items-center updateContact">
        <section class="flex flex-col">
            ...
            <input class="input_password std_input w-[500px]" id="firstName" name="firstName" type="text" value="<?php echo $fName; ?>">
        </section>

        <section class="flex flex-col">
            <label class="text-red-600 text-xl" for="lastName">Last name</label>
            <input class="input_password std_input w-[500px]" id="lastName" name="lastName" type="text" value="<?php echo $lName; ?>">
        </section>

        <section class="flex flex-col">
            <label class="text-red-600 text-xl" for="email">Email</label>
            <input class="input_password std_input w-[500px]" id="email" name="email" type="email" value="<?php echo $email; ?>">
        </section>

        <section class="flex flex-col">
            <label class="text-red-600 text-xl" for="phoneNumber">Phone number</label>
            <input class="input_password std_input w-[500px]" id="phoneNumber" name="phoneNumber" type="tel" value="<?php echo $phoneNumber; ?>">
        </section>

        <section class="flex flex-col">
            <label class="text-red-600 text-xl" for="city">City</label>
            <input class="input_password std_input w-[500px]" id="city" name="city" type="text" value="<?php echo $city; ?>">
        </section>
        
        <section class="flex flex-col">
            <label class="text-red-600 text-xl" for="streetName">Street name</label>
            <input class="input_password std_input w-[500px]" id="streetName" name="streetName" type="text" value="<?php echo $streetName; ?>">
        </section>

        <section class="flex flex-col">
            <label class="text-red-600 text-xl" for="houseNumber">House number</label>
            <input class="input_password std_input w-[500px]" id="houseNumber" name="houseNumber" type="text" value="<?php echo $houseNumber; ?>">
        </section>
