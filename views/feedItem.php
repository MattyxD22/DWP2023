<div class="feed_item" data-id="<?php echo $post[0] ?>">
    ...
    <div class="feed_footer h-1/6 pt-2">
        ...
        <div class="likes_div pe-4 my-auto">
            ...
            <span class="text-red-600 text-l font-bold likes_amount <?php echo $post[10] == 1 ? 'underline' : ''; ?>"><?php echo $post[8]; ?></span>
            <span class="text-white text-l font-bold ms-1">Likes</span>

        </div>

        <div class="dislikes_div pe-4 my-auto">
            <span class="text-red-600 text-l font-bold dislikes_amount <?php echo $post[11] == 1 ? 'underline' : ''; ?>"><?php echo $post[9]; ?></span>
