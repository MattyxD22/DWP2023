<div class="feed_item" data-id="<?php echo $value[0] ?>">
        ...
        <div class="feed_image_container h-full overflow-hidden flex">
            ...
            <?php if (!empty($value[6])) { ?>
                <div class="feed_img_container  h-full flex flex-row justify-center items-center my-auto mx-auto">
                    <img class="object-contain h-full" src="data:image/jpeg;base64,<?php echo base64_encode($value[6]); ?>">
                </div>

                <dialog class="imgDialog">

                    <div class="dialogContainer flex flex-col">

                        <div class="dialogContainer_image flex flex-row">
                            ...
                            <div class="dialogContainer_image flex flex-row w-full justify-center">
                                ...
                                <?php foreach ($imgData as $key => $img) {
                                    $count = 1;

                                    if ($count == 1) { ?>
                                        <img class="object-contain h-full modalImg active" data-img="<?php echo $count ?>" src="data:image/jpeg;base64,<?php echo base64_encode($img[0]); ?> ">
                                    <?php
                                    } else { ?>
                                        <img class="object-contain h-full modalImg" data-img="<?php echo $count ?>" src="data:image/jpeg;base64,<?php echo base64_encode($img[0]); ?>">
                                <?php }
                        ...
                        <div class="flex flex-row">
                            ...
                            <div class="absolute inset-x-0 bottom-0 z-[2] flex list-none justify-center p-0" data-te-carousel-indicators>
                                <button type="button" class="imgIndicator active mx-1" data-img="1"><i class="bi bi-circle-fill"></i></button>
                                <button type="button" class="imgIndicator mx-1" data-img="2"><i class="bi bi-circle-fill"></i></button>
                                <button type="button" class="imgIndicator mx-1" data-img="3"><i class="bi bi-circle-fill"></i></button>
                                <button type="button" class="imgIndicator mx-1" data-img="4"><i class="bi bi-circle-fill"></i></button>
                            </div>
                        </div>
    ...
    <div class="feed_footer h-1/6 pt-2">
        ...
        <div class="dislikes_div pe-4 my-auto">
            <span class="text-red-600 text-l font-bold"><?php echo $value[9] ?></span>
            <span class="text-white text-l font-bold ms-1">Dislikes</span>
        </div>


        <div class="reposts_div pe-4 my-auto">
            <span class="text-red-600 text-l font-bold"><?php echo $value[12]; ?></span>
